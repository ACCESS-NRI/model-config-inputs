...
### Links/relationships
These files are updates to the files in `/g/data/vk83/configurations/inputs/access-esm1p6/modern/amip/atmosphere/boundary_conditions/global.N96/2026.04.21`. They use the same source data and have the following additional corrections:
- Incorrect values in the fixed length headers have been replaced
- Only points with land fraction equal to 1 have been masked, rather than points with land fraction > 0 (using `/g/data/vk83/configurations/inputs/access-esm1p5/modern/share/atmosphere/land_fraction/global.N96/2019.11.25/qrparm.landfrac`)
- Values in the polar rows are replaced by zonal mean values. This is required to prevent instabilities in the UM.
