...
# Restart file for ESM 1.6 scen7-vl configuration
...
This restart file is copied from `/g/data/jq44/access-nri/access-esm1p6/global/historical/r1i1p1f1/2026.06.12/restart171/`, the calendar year 2022 restart from the concentrations driven historical ensemble member r1i1p1f1. The atmosphere land fields have been updated for consistency with the vl scenario land use change and wood thinning data via the `setup_scenario_restart.py` script in https://github.com/ACCESS-NRI/access-esm1.6-configs/pull/979.
