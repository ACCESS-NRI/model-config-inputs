...
# Restart file for ESM 1.6 esm-scen7-h configuration
...
The 2022 land use and wood thinning data used to modify the atmospheric restart `restart_dump.astart` is taken from the files in `/g/data/vk83/configurations/inputs/access-esm1p6/modern/scen7-h/atmosphere/land/vegetation/global.N96/2026.08.28`.
...
This restart file is copied from `/g/data/jq44/access-nri/access-esm1p6/global/esm-historical/r1i1p1f1/2026.06.12/restart171`, the calendar year 2022 restart from the emissions driven historical ensemble member r1i1p1f1. The atmosphere land fields have been updated for consistency with the h scenario land use change and wood thinning data via the `setup_scenario_restart.py` script in https://github.com/ACCESS-NRI/access-esm1.6-configs/pull/1023.
